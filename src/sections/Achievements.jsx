...
export default function Achievements() {
  return (
    <section id="achievements" style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "flex-end", padding: "80px 5vw", position: "relative" }}>
      ...
      <div style={{ position: "absolute", top: 0, left: 0, width: "100%", overflow: "hidden", opacity: 0.15, pointerEvents: "none" }}>
      ...
      >
        ...
        <motion.div
          ...
          style={{
            ...
            border: "2px dashed #ffd43b", borderRadius: 8,
            padding: "12px 32px 28px",
            boxShadow: "0 10px 40px rgba(0,0,0,0.05)", position: "relative"
          }}
        >
          ...
          <motion.div variants={container} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }}>
            {items.map((it, i) => (
              <motion.div key={i} variants={item} style={{
                ...
                padding: "14px 0", borderBottom: i < items.length - 1 ? "1px dashed #dcdcdc" : "none"
              }}>
                <motion.div
                  animate={{ scale: [1, 1.25, 1] }}
                  transition={{ duration: 2.5, repeat: Infinity, delay: i * 0.4 }}
                  style={{ width: 12, height: 12, borderRadius: "50%", background: it.color, flexShrink: 0 }}
                />
