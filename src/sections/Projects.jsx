...
import { FabricPatch } from "../components/EmbroideryElements"

const projects = [
  { title:"ChainSentinel AI",    sub:"Web3 Security",    color:"#ff6b6b", tag:"Current",   desc:"AI-powered Web3 threat detection using ML for anomaly detection and risk scoring." },
  ...
  { title:"Dual Screwdriver",    sub:"Electromechanical",color:"#ffd43b", tag:"Completed", desc:"Bidirectional motor-based tool with DPDT polarity reversal system." },
  ...
  return (
    <section id="projects" style={{ minHeight:"100vh", display:"flex", alignItems:"center", padding:"80px 5vw", position:"relative" }}>
      ...
      >
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fill,minmax(280px,1fr))", gap:28, marginTop:36 }}>
          {projects.map((p,i) => (
            <motion.div key={p.title}
              ...
              style={{ background:"#fff", border:"2px dashed "+p.color, borderRadius:8, padding:"24px", boxShadow:"0 8px 30px rgba(0,0,0,0.05)", position:"relative", cursor:"default", overflow:"visible" }}
            >
              <FabricPatch color={p.color} size={70} />
              <div style={{ position:"absolute", inset:5, border:"1px dashed "+p.color, borderRadius:6, opacity:0.2, pointerEvents:"none" }} />
